      ...
      <View className="p-4">
        ...
        <View className="flex-row flex-wrap justify-between">
          {categories.map((category) => (
            ...
            >
              <View className="items-center justify-center h-16 w-16 rounded-full bg-blue-100 mx-auto mb-3">
                <FontAwesomeIcon
              ...
              <Text className="text-center text-sm text-gray-500 mb-2" numberOfLines={2}>
                {category.description}
              </Text>

              <View className="flex-row items-center justify-center bg-blue-50 rounded-full py-1">
